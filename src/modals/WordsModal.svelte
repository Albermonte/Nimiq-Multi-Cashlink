...
<div class="grid grid-cols-2 grid-rows-4" style="place-items: center">
  <header class="nq-h2 col-span-2 my-2">
    Don't forget to save your 24 words
  </header>
  <button
  ...
  <p class="col-span-2 text-center mx-4 text-3xl text-gray-700 max-w-3xl">
    {mnemonic}
  </p>
  <button
    class="nq-button-pill red text-white px-6"
    on:click={() => showModal.set(null)}>Cancel</button
  >
  <button
